...
Title = uicontrol('Style','Edit','Position',[30 265 340 35],'Parent',InfoFig,'BackgroundColor',[1 1 1],...
    'HorizontalAlignment','Center','FontSize',12,'String',title_text);

uipanel('Title', 'Project Description', 'Units', 'Pixels', 'Position', [20 70 360 180], 'BackgroundColor', [.7 .8 .7], 'FontSize', 12, 'ForegroundColor', [.1 .1 .1]);
Description = uicontrol('Style','Edit','Position',[30 80 340 145],'Parent',InfoFig,'BackgroundColor',[1 1 1],...
