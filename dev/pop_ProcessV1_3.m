function [status] = pop_ProcessV(Direct, subslist, analyoutput)
...
%           find field names from rawdata and move them to procdata
            ...
            if analyoutput(1)
%                 keyboard
                [classinfo, pointinfo] = fixsacv1_1_2FORVALID_SPattmpt(x,y,d,sr,gapdata,2,40,150,procdata.sub(subn).Trial(trinum).WhatsOn);
