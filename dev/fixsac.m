function [fixinfo, sacinfo, pointinfo, variance] = fixsac(x,y,d,sr,gapdata,fff)
%FixDetectDev
%
...
% ADJUST NEW BLINK FORMAT AND DEAL WITH OTHER GAPS AS WELL


% 1. make new array of non-nans
% 1.5 make new array of zeros
% 2. create index of original nan locations
% 3. put nans into new blank array
% 4. new array(~isnan original) = original

%% Deal with incoming gap information
% Some will be blinks; others will be chunks that are too large to be
% blinks and also cannot be interpolated
