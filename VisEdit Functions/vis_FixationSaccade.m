...
FixDetWin = figure('Units','Normalized','Position',[.1 .1 .85 .75],'Menubar','none','Toolbar','Figure','NumberTitle','Off','Color',[.65 .75 .65],...
...
Sel_Sub = uipanel('Title', ['Subject: ' text_sub], 'Units', 'Normalized', 'Position', [640 652 290 50] ./ [1120 702.5 1120, 702.5],...
  'BackgroundColor', [.7 .8 .7], 'FontSize', 12, 'ForegroundColor', [.1 .1 .1]);
Sel_Tri = uipanel('Title', ['Trial: ' text_tri], 'Units', 'Normalized', 'Position', [640 597 290 50] ./ [1120 702.5 1120, 702.5],...
  'BackgroundColor', [.7 .8 .7], 'FontSize', 12, 'ForegroundColor', [.1 .1 .1]);
Sel_Seg = uipanel('Title', ['Trial Segment: ' num2str(seg_vis), '/1'], 'Units', 'Normalized', 'Position', [640 542 180 50] ./ [1120 702.5 1120, 702.5],...
  'BackgroundColor', [.7 .8 .7], 'FontSize', 12, 'ForegroundColor', [.1 .1 .1]);
uipanel('Title', 'Length(ms):', 'Units', 'Normalized', 'Position', [825 542 105 50] ./ [1120 702.5 1120, 702.5],...
  'BackgroundColor', [.7 .8 .7], 'FontSize', 12, 'ForegroundColor', [.1 .1 .1]);


if length(subslist)>1
  Slide_Sub = uicontrol('Style','Slider','Min',1,'Max',length(subslist),...
    'Units','Normalized','Value',1,'SliderStep',[1/(length(subslist)-1), 1/(length(subslist)-1)],...
    'Position',[650 659.5 210 20] ./ [1120 702.5 1120, 702.5],'Callback',@slide_sub);
end

Load_SubButton = uicontrol('Style','PushButton','String','Load','Units','Normalized','Position',[870 657 50 27.5] ./ [1120 702.5 1120, 702.5],...
  'BackgroundColor',[.8 .8 .8],'Callback',@loadsub);
Slide_Tri = uicontrol('Style','Slider','Min',1,'Max',99,...
  'Value',1,'SliderStep',[1 1],'Units','Normalized',...
  'Position',[650 604.5 270 20] ./ [1120 702.5 1120, 702.5],'Callback',@slide_tri,'Enable','Off');

GazeAxes = axes('Parent',FixDetWin,'Units','Normalized','Position',[60 50 870 440] ./ [1120 702.5 1120, 702.5],...
...
TagAxes = axes('Parent',FixDetWin,'Units','Normalized','Position',[60 492 870 40] ./ [1120 702.5 1120, 702.5],...
...
Scroll_Right = uicontrol('Style','PushButton','String','>>>','Parent',FixDetWin,'Units','Normalized',...
  'Position',[735 547 75 25] ./ [1120 702.5 1120, 702.5],'Backgroundcolor',[.8 .8 .8],'Enable','Off',...
  'Callback',@scroll_right);
Scroll_Left = uicontrol('Style','PushButton','String','<<<','Parent',FixDetWin,'Units','Normalized',...
  'Position',[650 547 75 25] ./ [1120 702.5 1120, 702.5],'Backgroundcolor',[.8 .8 .8],'Enable','Off',...
  'Callback',@scroll_left);
WinSize = uicontrol('Style','Edit','Enable','Off','String','3000','Units','Normalized',...
  'Position',[835 547 85 25] ./ [1120 702.5 1120, 702.5],'FontSize',12,'Callback',@disp_trial_gui);

%% Settings Summary and Editing
PreSumm = uicontrol('Style','Text','Parent',FixDetWin,'Units','Normalized','Position',[110 645 290 40] ./ [1120 702.5 1120, 702.5],'String',...
  '','CreateFcn',@pre_text,'BackgroundColor',[.7 .8 .7]);
PreEdit = uicontrol('Style','PushButton','String','Edit','Parent',FixDetWin,'Units','Normalized',...
  'Position',[60 645 40 40] ./ [1120 702.5 1120, 702.5],'BackgroundColor',[.8 .8 .8],'Callback',@pre_edit,'Enable','Off');
FixSumm = uicontrol('Style','Text','Parent',FixDetWin,'Units','Normalized','Position',[110 590 290 40] ./ [1120 702.5 1120, 702.5],'String',...
  '','CreateFcn',@fix_text,'BackgroundColor',[.7 .8 .7]);
FixEdit = uicontrol('Style','PushButton','String','Edit','Parent',FixDetWin,'Units','Normalized',...
  'Position',[60 590 40 40] ./ [1120 702.5 1120, 702.5],'BackgroundColor',[.8 .8 .8],'Callback',@fix_edit,'Enable','Off');

%% Fixation Summary List
FixSumPan = uipanel('Title', 'Fixation Summary:', 'Units', 'Normalized', 'Position', [940 50 175 645] ./ [1120 702.5 1120, 702.5],...
  'BackgroundColor', [.7 .8 .7], 'FontSize', 12, 'ForegroundColor', [.1 .1 .1]);

uicontrol('Style','Text','Parent',FixSumPan,'Units','Normalized','Position',[5 605 160 15]./[175 645 175 645],'String','No.  Start   End   Duration',...
  'FontSize',10,'BackgroundColor',[.7 .8 .7],'HorizontalAlignment','Left','FontAngle','Italic');
FixSumList_No = uicontrol('Style','Text','Parent',FixSumPan,'Units','Normalized','Position',[5 5 35 595]./[175 645 175 645],'String','',...
  'FontSize',8,'BackgroundColor',[.7 .8 .7],'HorizontalAlignment','Left','FontWeight','Normal');
FixSumList_Str = uicontrol('Style','Text','Parent',FixSumPan,'Units','Normalized','Position',[45 5 35 595]./[175 645 175 645],'String','',...
  'FontSize',8,'BackgroundColor',[.7 .8 .7],'HorizontalAlignment','Left','FontWeight','Normal');
FixSumList_End = uicontrol('Style','Text','Parent',FixSumPan,'Units','Normalized','Position',[85 5 35 595]./[175 645 175 645],'String','',...
  'FontSize',8,'BackgroundColor',[.7 .8 .7],'HorizontalAlignment','Left','FontWeight','Normal');
FixSumList_Dur = uicontrol('Style','Text','Parent',FixSumPan,'Units','Normalized','Position',[125 5 35 595]./[175 645 175 645],'String','',...
  'FontSize',8,'BackgroundColor',[.7 .8 .7],'HorizontalAlignment','Left','FontWeight','Normal');

%% Gross Fixation Auditing
EB_New = uicontrol('Style','Pushbutton','String','New Fixation','BackgroundColor',[.8 .8 .8],...
  'Units','Normalized','Position',[60 542 77.5 38] ./ [1120 702.5 1120, 702.5],'Enable','Off');
EB_Delete = uicontrol('Style','Pushbutton','String','Delete Fixation','BackgroundColor',[.8 .8 .8],...
  'Units','Normalized','Position',[147.5 542 77.5 38] ./ [1120 702.5 1120, 702.5],'Enable','Off');
EB_Merge = uicontrol('Style','Pushbutton','String','Merge Fixations','BackgroundColor',[.8 .8 .8],...
  'Units','Normalized','Position',[235 542 77.5 38] ./ [1120 702.5 1120, 702.5],'Enable','Off');
EB_Split = uicontrol('Style','Pushbutton','String','Split Fixations','BackgroundColor',[.8 .8 .8],...
  'Units','Normalized','Position',[322.5 542 77.5 38] ./ [1120 702.5 1120, 702.5],'Enable','Off');

%% Fine Editing buttons
SE_Edge = uibuttongroup('Visible','On','units','Normalized','Position',[410 542 220 96] ./ [1120 702.5 1120, 702.5],'BackGroundColor',[.7 .8 .7],...
...
edge_left = uicontrol('Style','RadioButton','String','Left','Enable','On','Value',1,...
  'Units','Normalized','Position',[12.5 60 60 25]./[220 96 220 96],'FontSize',10,'Parent',SE_Edge,'BackGroundColor',[.7 .8 .7],...
  'Value',curr_edge==1,'UserData',1);
edge_right = uicontrol('Style','RadioButton','String','Right','Enable','On','Value',0,...
  'Units','Normalized','Position',[62.5 60 60 25]./[220 96 220 96],'FontSize',10,'Parent',SE_Edge,'BackGroundColor',[.7 .8 .7],...
  'Value',curr_edge==-1,'UserData',-1);
uicontrol('Style','Text','String','Size:','Parent',SE_Edge,'Units','Normalized','Position',[135 60 45 25]./[220 96 220 96],'FontSize',10,...
  'BackgroundColor',[.7 .8 .7])
uicontrol('Style','Edit','String','5','Parent',SE_Edge','Units','Normalized','Position',[180 60 30 25]./[220 96 220 96],'FontSize',10,...
  'Callback',@edge_size)
uipanel('Units', 'Normalized', 'Position', [540 590 2 39] ./ [1120 702.5 1120, 702.5],...
  'BackgroundColor', [.7 .8 .7], 'ForegroundColor', [.1 .1 .1]);
uipanel('Units', 'Normalized', 'Position', [410 587.5 220 2] ./ [1120 702.5 1120, 702.5],...
  'BackgroundColor', [.7 .8 .7], 'ForegroundColor', [.1 .1 .1]);

FineMMM = uicontrol('Style','PushButton','String','---','Parent',SE_Edge,'Units','Normalized','Position',[5 5 48.75 35]./[220 96 220 96],...
  'BackgroundColor',[.8 .8 .8],'FontSize',12,'Enable','Off','Callback',[]);
FineM = uicontrol('Style','PushButton','String','-','Parent',SE_Edge,'Units','Normalized','Position',[58.75 5 48.75 35]./[220 96 220 96],...
  'BackgroundColor',[.8 .8 .8],'FontSize',12,'Enable','Off','Callback',[]);
FineP = uicontrol('Style','PushButton','String','+','Parent',SE_Edge,'Units','Normalized','Position',[111.5 5 48.75 35]./[220 96 220 96],...
  'BackgroundColor',[.8 .8 .8],'FontSize',12,'Enable','Off','Callback',[]);
FinePPP = uicontrol('Style','PushButton','String','+++','Parent',SE_Edge,'Units','Normalized','Position',[164.25 5 48.75 35]./[220 96 220 96],...
  'BackgroundColor',[.8 .8 .8],'FontSize',12,'Enable','Off','Callback',[]);
...
set(fixbrush,'ActionPostCallback',@fix_brush,'Color',[1 .7 .7])
  ...
  function disp_trial_gui(~,~)
    currStr = get(WinSize,'string');
    currVal = str2num(currStr);
    if currVal < 500
      h = msgbox(['Warning: segment size too small, setting to 500ms']);
      waitfor(h)
      currStr = '500';
      currVal = 500;
    end
    ...
    seg_sizeP = currVal * (subdata.SampleRate/1000);
    set(WinSize,'String',currStr)
    disp_trial
  end
...
%% Menu Controls
  ...
  function gen_diag(in_str)
    diagfig=dialog('Color',[.7 .8 .7], 'Name', 'Please Wait','Units','Normalized','Position',[1200 498.75 200 100]./[1120 702.5 1120 702.5],'Visible','On');
    uicontrol('Style','Text','Parent',diagfig,'String',in_str,'BackgroundColor',[.7 .8 .7],'FontSize',14,...
      'Units','Normalized','Position',[5 10 190 80] ./ [1120 702.5 1120, 702.5])
    pause(.1)
  end
